...
#os.environ['KAGGLE_USERNAME'] = 'harinidhara'
#os.environ['KAGGLE_KEY'] = '8f2a3fb9406a373897a04296f9a11b8c'
...
model_file = os.path.join('outputs', 'DisasterTweets_model1.pkl')
...
Model.register(workspace=run.experiment.workspace,
               ...
               model_name = 'DisasterTweet_model1')
...
model = ws.models['DisasterTweet_model1']
...
model_path = os.path.join(temp_dir, 'DisasterTweets_model1.pkl')
